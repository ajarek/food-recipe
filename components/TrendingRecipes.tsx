...
const TrendingRecipes = () => {
  return (
    <div className='flex flex-col items-center justify-center mt-4 gap-4 '>
      <h1 className='text-2xl font-semibold'>Trending <span className='text-primary'>Recipes</span></h1>
      ...
      <CarouselContent className="-ml-1">
        ...
        />
               ...
               <CardFooter className="h-20 p-1 text-primary">{recipe.name}</CardFooter>
               </Link>
             </Card>
           </div>
         </CarouselItem>
